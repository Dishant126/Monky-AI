...
import MazeRunner from '@/components/games/maze-runner'
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-3xl font-bold text-white">Maze Runner</h2>
              <p className="text-gray-400">Navigate through the maze using your keyboard arrows</p>
            </div>
          </div>
        </div>
