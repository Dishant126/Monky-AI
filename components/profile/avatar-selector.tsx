...
import { PROFILE_AVATARS } from "@/lib/constants/avatars";

const PRESET_AVATARS = PROFILE_AVATARS.map((url, index) => ({
  id: `avatar-${index + 1}`,
  url,
  name:
    url
...
export function AvatarSelector({
  ...
  const [selectedAvatar, setSelectedAvatar] = useState<string>(
    currentAvatar || PRESET_AVATARS[0].url,
  );
