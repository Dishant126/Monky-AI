...
import { Mic, MicOff, Volume2, VolumeX, Loader, AlertCircle, Send } from 'lucide-react'
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <button 
              ...
              className="flex items-center space-x-1 text-sm bg-slate-700/50 hover:bg-slate-700/80 px-3 py-1.5 rounded-full transition-colors"
            >
              {autoSpeak ? (
                <>
                  <Volume2 className="h-4 w-4 text-green-400" />
                  <span className="text-slate-300">Voice On</span>
                </>
              ) : (
                <>
                  <VolumeX className="h-4 w-4 text-slate-400" />
                  <span className="text-slate-400">Voice Off</span>
                </>
              )}
            </button>
          </div>
